export const GBIF_TAXON_KEY = 212     // Class Aves
export const INAT_TAXON_ID = 3        // Class Aves on iNat
...
export const SPECIES_META = {
  ...
  // ─── Atlantic Puffin ────────────────────────────────────────────────────────
  2481353: {
    common: 'Atlantic Puffin', scientific: 'Fratercula arctica',
    color: '#1a1a1a', emoji: '🐧',
    fact: 'Nicknamed "clowns of the sea" for their colorful bills, puffins can carry 10 or more fish at once in their beaks. They spend most of their lives at sea, only coming to land to breed on coastal cliffs.',
    photoUrl: 'https://inaturalist-open-data.s3.amazonaws.com/photos/129583540/medium.jpg',
    iucn: 'VU',
  },
  ...
  5228514: {
    ...
    color: '#2d8a4e', emoji: '🐦',
    fact: 'The only hummingbird that breeds in eastern North America. Despite weighing less than a nickel, it migrates 800 km non-stop across the Gulf of Mexico each spring and fall, beating its wings 53 times per second.',
    photoUrl: 'https://inaturalist-open-data.s3.amazonaws.com/photos/202849498/medium.jpg',
    iucn: 'LC',
  },
  ...
  9510564: {
    ...
    color: '#e67e22', emoji: '🐦',
    fact: 'Despite its name, the American robin is a thrush, not related to the European robin. It can detect earthworms underground by sight, not sound, tilting its head to focus one eye on tiny soil disturbances.',
    photoUrl: 'https://inaturalist-open-data.s3.amazonaws.com/photos/240099876/medium.jpg',
    iucn: 'LC',
  },
  ...
  // ─── Common Kingfisher ─────────────────────────────────────────────────────
  2475532: {
    common: 'Common Kingfisher', scientific: 'Alcedo atthis',
    color: '#00bcd4', emoji: '🐦',
    fact: 'The kingfisher\'s beak inspired the design of Japan\'s Shinkansen bullet train. Engineers modeled the train\'s nose after the bird\'s bill to reduce the sonic boom created when entering tunnels at high speed.',
    photoUrl: 'https://inaturalist-open-data.s3.amazonaws.com/photos/161907753/medium.jpg',
    iucn: 'LC',
  },
}

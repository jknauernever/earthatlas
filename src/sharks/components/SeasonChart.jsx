...
export default function SeasonChart({ pattern = [], activeMonth, onMonthChange, loading, styles }) {
  ...
  if (loading) return <div className={styles.shimmerCard} style={{ height: 120 }} />
    ...
    <div>
      ...
      <div className={styles.seasonDetail}>
        {displayMonth !== null && displayMonth !== undefined ? (
          ...
          <span className={styles.seasonDetailHint}>Click a month to see historical sightings for that time of year</span>
        )}
      </div>
    </div>
  )
